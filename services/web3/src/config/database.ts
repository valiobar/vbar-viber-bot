/**
 * MongoDB connection configuration for Web3 Service using Mongoose
 *
...
const defaultUri = `mongodb://web3:web3123@localhost:27021/web3?authSource=admin`;
let uri = ConfigHelper.getEnv("MONGODB_URI", defaultUri);
const dbName = ConfigHelper.getEnv("MONGODB_DB_NAME", "web3");
