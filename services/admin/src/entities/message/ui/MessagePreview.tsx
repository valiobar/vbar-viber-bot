...
interface MessagePreviewProps {
  ...
  /**
   * Keyboard preview injected by the parent (cross-entity composition via props)
   */
  keyboardPreview?: ReactNode;

  /**
   * Whether the injected keyboard preview is still loading
   */
