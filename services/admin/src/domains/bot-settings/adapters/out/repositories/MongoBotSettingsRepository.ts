/**
 * MongoDB BotSettings Repository Implementation
 *
 * Implements the BotSettingsRepository interface using Mongoose.
...
import {
  BotSettingsModel,
  IBotSettingsDocument,
} from "../models/BotSettingsModel";

/**
 * MongoDB BotSettings Repository
 *
 * Implements bot settings persistence operations using MongoDB/Mongoose.
 * Uses singleton pattern - only one settings document exists.
 */
export class MongoBotSettingsRepository implements BotSettingsRepository {
...
/**
 * Factory function to create MongoBotSettingsRepository instance
 *
 * @returns MongoBotSettingsRepository instance
 */
export function createMongoBotSettingsRepository(): MongoBotSettingsRepository {
  return new MongoBotSettingsRepository(BotSettingsModel);
}
