 ...
 *
 * Session persistence operations using Mongoose models.
 * Includes TTL index on expiresAt for automatic cleanup of expired sessions.
 */

import { connectToDatabase } from "@/lib/mongodb";
import { SessionModel, type ISessionDocument } from "./SessionModel";
...
/**
 * Session persistence operations using MongoDB/Mongoose.
