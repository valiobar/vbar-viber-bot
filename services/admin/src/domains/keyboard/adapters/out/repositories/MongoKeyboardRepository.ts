/**
 * MongoDB Keyboard Repository Implementation
 *
 * Implements the KeyboardRepository interface using Mongoose.
...
import { KeyboardModel, IKeyboardDocument } from "../models/KeyboardModel";
import { PaginationParams } from "@shared";

/**
 * MongoDB Keyboard Repository
 *
 * Implements keyboard persistence operations using MongoDB/Mongoose.
 */
export class MongoKeyboardRepository implements KeyboardRepository {
  ...
  private entityToDocument(keyboard: Keyboard): Partial<IKeyboardDocument> {
    return {
      ...
      botId: keyboard.botId, // botId is stored as String
...
/**
 * Factory function to create MongoKeyboardRepository instance
 *
 * @returns MongoKeyboardRepository instance
 */
export function createMongoKeyboardRepository(): MongoKeyboardRepository {
  return new MongoKeyboardRepository(KeyboardModel);
}
