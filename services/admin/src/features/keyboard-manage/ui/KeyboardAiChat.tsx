...
import { AiChatDrawer, useAiChat } from "@/shared";
import type {
      ...
      {phase === "result" && result && (
        <div className="space-y-3">
          {result.missingFields.length > 0 && (
            <div className="rounded-md border border-amber-300 bg-amber-50 p-3 text-sm dark:border-amber-600 dark:bg-amber-900/40">
              <p className="font-medium text-amber-800 dark:text-amber-200">
                Missing required fields — fill these in the form:
              </p>
